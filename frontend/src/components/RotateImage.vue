...
<template>
	<div class="RotateImage">
		<section>
			...
			<div><img src="../assets/5-2.png" alt=""></div>
			<div><img src="../assets/5-3.png" alt=""></div>
			<div><img src="../assets/5-4.png" alt=""></div>
			<div><img src="../assets/5-5.png" alt=""></div>
			<div><img src="../assets/5-6.png" alt=""></div>
		</section>
	</div>
</template>
